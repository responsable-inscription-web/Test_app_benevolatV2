...
window.SEED = {
  reglages: {
    poles: [
      { nom: "Restaurant", capacite: 3, responsable: "responsable-restauration@example.org", actif: true },
      { nom: "Gouvernance", capacite: 3, responsable: "gouvernance@example.org", actif: true },
      { nom: "Espaces verts", capacite: 2, responsable: "", actif: true },
      { nom: "Travaux", capacite: 2, responsable: "", actif: true },
      { nom: "Maintenance", capacite: 1, responsable: "", actif: true },
      { nom: "Studio d'Art", capacite: 2, responsable: "", actif: true },
      { nom: "CPS Com", capacite: 1, responsable: "", actif: true },
      { nom: "World Peace Café", capacite: 2, responsable: "", actif: true },
    ],
    fermetures: [
    ...
    regles: {
      dureeMin: 8, exceptionDuree: "Studio d'Art", ageMin: 18,
    ...
    // Tarifs FICTIFS pour la démonstration : à remplacer par les vrais tarifs réduits.
    tarifs: { nuitDortoir: 12, repasJour: 15, jetonLessive: 4 },
    modeles: {
      invitation: {
      ...
      attestation: {
        nom: "Lien d'attestation", declencheur: "La veille du départ",
  ...
  sejours: [
    ...
    { id: 6, benevole: "BEN-00108", arrivee: "2026-09-05", depart: "2026-09-20", heureArrivee: "", heureDepart: "", navette: "Non", souhaits: ["Travaux"], pole: "Travaux", statut: "Parti·e", canal: "Workaway", sante: "", repos: ["2026-09-12", "2026-09-13"], lit: "",
      attestation: { statut: "validée", jetons: 2, signeLe: "2026-09-19T20:02", jours: {} } },
    ...
    { id: 11, benevole: "BEN-00103", arrivee: "2026-11-12", depart: "2026-11-30", heureArrivee: "", heureDepart: "", navette: "Oui", souhaits: ["Restaurant", "Gouvernance"], pole: null, statut: "Reçue", canal: "Workaway", sante: "", repos: [], lit: "", attestation: null },
    { id: 12, benevole: "BEN-00111", arrivee: "2026-10-08", depart: "2026-10-22", heureArrivee: "", heureDepart: "", navette: "Non", souhaits: ["Travaux"], pole: null, statut: "Reçue", canal: "Worldpackers", sante: "", repos: [], lit: "", attestation: null },
